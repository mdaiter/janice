...
"armv7l-linux-thread-multi-3.2.34-1-farm" or
	die "Errno architecture (armv7l-linux-thread-multi-3.2.34-1-farm) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
